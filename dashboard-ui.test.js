...
test("home loads the Dashboard Core assets after the authenticated Supabase client", () => {
  ...
  assert.match(serviceWorker, /cucina-hub-v37/i);
...
test("dashboard renders the operational metrics, agenda and quick actions", () => {
  ...
  for (const label of ["Pasti di oggi", "Lista spesa", "Meal Prep", "Notifiche", "Azioni rapide", "Assistente AI", "Biblioteca in breve"])
