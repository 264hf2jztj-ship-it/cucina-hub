...
test("dashboard renders the operational metrics, agenda and quick actions", () => {
  ...
  for (const label of ["Pasti di oggi", "Planner Hub", "Lista spesa", "Meal Prep", "Notifiche", "Learning", "Analytics", "Esperimenti", "Versioni ricette", "Lettore EPUB e PDF", "Laboratorio", "Ricerca", "Azioni rapide", "Assistente AI", "Biblioteca in breve"])
