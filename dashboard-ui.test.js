...
test("home loads the Dashboard Core assets after the authenticated Supabase client", () => {
  ...
  assert.match(serviceWorker, /cucina-hub-v28/i);
...
test("dashboard renders the operational metrics, agenda and quick actions", () => {
  ...
  for (const label of ["Planner Hub", "Lista spesa", "Meal Prep", "Notifiche", "Learning", "Analytics", "Esperimenti", "Versioni ricette", "Laboratorio", "Ricerca"]) {
