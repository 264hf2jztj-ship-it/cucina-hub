...
assert.match(html, /planner\.css\?v=6/i);
assert.match(html, /menu-plan-import-engine\.js\?v=4/i);
assert.match(html, /planner\.js\?v=6/i);
assert.match(home, /href="planner\/index\.html\?v=6"/i);
assert.match(html, /accept="\.json,\.md,\.txt/i);
assert.match(html, /ANTEPRIMA/i);
