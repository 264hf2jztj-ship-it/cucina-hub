...
assert.match(html, /planner\.js\?v=12/i);
assert.match(home, /href="planner\/index\.html\?v=13"/i);
assert.match(html, /href="calendar\.html\?v=2"/i);
assert.match(html, /href="notifications\.html\?v=1"/i);
