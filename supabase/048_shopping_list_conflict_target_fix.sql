...
-- RETURNS TABLE exposes week_start as a PL/pgSQL output variable. PostgreSQL
-- therefore treats the partial-index inference target in ON CONFLICT as
-- ambiguous unless this function explicitly prefers table columns.
